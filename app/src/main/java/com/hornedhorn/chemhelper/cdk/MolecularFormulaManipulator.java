package com.hornedhorn.chemhelper.cdk;
...
public class MolecularFormulaManipulator {
     ...
     */
    private static String breakExtractor2(String formula) {
        ...
        for (int f = 0; f < formula.length(); f++) {
            ...
            if (!started) {
                ...
                if (finalBreak) {
                    ...
                    if (thisChar == ')' && !finalBreak) {
                        // first encountered ")", that closes the last encountered "(".
                        finalBreak = true;
                    }else if ( thisChar == '(' ) {
                        //always take the last encountered "(", to remove the inner most brackets
                        finalformula += "(" + multipliedformula;
                        multipliedformula = "";
                    }else
